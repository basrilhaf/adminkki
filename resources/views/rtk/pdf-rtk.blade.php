...
<head>
  ...
  <title>RTK_<?php echo $t[2].$t[1].$t[0]?>_Cabang<?php echo $cabang;?></title>
                    ...
                    <div class="card" style="color:black;">
                        <div class="card-body">
                            <div class="form-group">
                               <h3 style="text-align:center; ">Rangkuman Transaksi Kelompok (RTK) - Lembar 1</h3>
                            </div>
                            ...
                            <div style="display:inline-block;">
                                <table class="table-bordered table-responsive-sm" style="font-size:12px; margin-top:1px;" >
                                    <tbody>
                                        <tr style="background-color:#c3ebb2;">
                                            ...
                                            <td class="w-1" colspan="4">Setoran Mingguan</td>
                                            <td class="w-222" rowspan="2">Kd Byr Khusus</td>
                                            <td class="w-222" rowspan="2" style="border: 0.2em solid #0a0808;">Jml Uang ke kasir</td>
                                        ...
                                        <tr style="background-color:#c3ebb2;">
                                            ...
                                            <td>Set ke-</td>
                                            <td>Acuan</td>
                                            <td class="w-22">Setoran</td>
                                            <td class="w-22">T.Pribadi Masuk</td>
                                            <td class="w-22"  style="border-left: 0.2em solid #0a0808;">Pinjaman Dicairkan</td>
                                            <td>TSA</td>
                                            <td>Simjib</td>
                                            <td class="w-222">T.Wajib Cair</td>
                                            <td>Paraf PCR</td>
                                            <td>Paraf BTAB</td>
                                        </tr>
                                         <?php 
                                            ...
                                            if($rows->btab_btk=="BTK"){
                                                if($rows->durasi=="25"){
                                                    ...
                                                    if($rows->set_ke_rtk == "29.25"){
                                                        $acuan = (($rows->set_mingguan_rtk*75)/100)/1000;
                                                    } else if($rows->set_ke_rtk == "29.5"){
                                                        $acuan = (($rows->set_mingguan_rtk*50)/100)/1000;
                                                    } else if($rows->set_ke_rtk == "29.75"){
                                                        $acuan = (($rows->set_mingguan_rtk*25)/100)/1000;
                                                    } else if($rows->set_ke_rtk == "30"){
                                                        $acuan = (($rows->set_mingguan_rtk*0)/100)/1000;
                                                    } else {
                                                        $set_next = $rows->set_ke_rtk; 
                                                        $acuan = $rows->set_mingguan_rtk/1000; 
                                                    }
                                        ...
                                        <tr style="height:22px;">
                                            ...
                                            <td style="text-align:left;"><?php echo substr($rows->nama_kelompok_rtk,0,15);?></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            <td colspan="5">Total (selesai/dipindahkan)</td>
                                            <?php if($tot==0){?>
                                            <td></td>
                                            <?php } else {?>
                                ...
                                ?>
                                <div class="form-group">
                                   <h3 style="text-align:center; margin-top:20px;">Rangkuman Transaksi Kelompok (RTK) - Lembar <?php echo $lembar_ke;?></h3>
                                </div>
                                <div style="display:block; margin-bottom:0px;">
                                <table style="border:none; font-size:13px;">
                                    ...
                                    <tr style="height:16px;">
                                        ...
                                        <td style="border:none; width:215px;"></td>
                                        <td style="border:none; width:20px;"></td>
                                        <td style="border:none;"></td>
                                ...
                                <table class="table-bordered table-responsive-sm" style="font-size:12px;" >
                                    <tbody>
                                        <tr style="background-color:#c3ebb2;">
                                            <td class="w-221" rowspan="2">Urut</td>
                                            <td class="w-11" colspan="2">Kumpulan</td>
                                            ...
                                            <td class="w-1" colspan="4">Setoran Mingguan</td>
                                            <td class="w-222" rowspan="2">Kd Byr Khusus</td>
                                            <td class="w-222" rowspan="2" style="border-left: 0.2em solid #0a0808;">Jml Uang ke kasir</td>
                                            <td class="w-2" colspan="6" style="border-left: 0.2em solid #0a0808;">Pencairan & BTAB</td>
                                        </tr>
                                        <tr style="background-color:#c3ebb2;">
                                            <td>No</td>
                                ...
                                ?>
                                <div class="form-group">
                                   <h3 style="text-align:center; margin-top:100px;;">Rangkuman Transaksi Kelompok (RTK) - Lembar <?php echo $lembar_ke;?></h3>
                                </div>
