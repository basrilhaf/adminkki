                                    ...
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label fs-6 fw-bold">EMAIL USER:</label>
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        <input type="text" class="form-control form-control-solid ps-13" id="search-user-email" placeholder="Nama role" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label fs-6 fw-bold">ROLE USER:</label>
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        <input type="text" class="form-control form-control-solid ps-13" id="search-user-role" placeholder="Kode role" />
                                                    </div>
                                                </div>
            ...
            $(document).ready(function () {
                $('#tableUser').DataTable({
                    ...
                    ajax: {
                        ...
                        data: function (d) {
                            d.nama_user = $('#search-user-nama').val();
                            d.email_user = $('#search-user-email').val();
                            d.role_user = $('#search-user-role').val();
                        }
                    },
                    columns: [
