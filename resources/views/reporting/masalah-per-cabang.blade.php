@include('layout.header')
        ...
        <script>
            $(document).ready(function () {
                var masalahAnggotaTable;   
                var masalahKelompokTable;     
                function initializeDataTable() {
                    if ($.fn.dataTable.isDataTable('#masalahAnggotaTable')) {
                        masalahAnggotaTable.ajax.reload();
                    } else {
                        masalahAnggotaTable = $('#masalahAnggotaTable').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: {
                    ...
                    var masalahKelompokTable;
                    if ($.fn.dataTable.isDataTable('#masalahKelompokTable')) {
                        masalahKelompokTable.ajax.reload();
                    } else {
                        // Otherwise, initialize the DataTable
                        masalahKelompokTable = $('#masalahKelompokTable').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: {
                ...
                $('#masalahCabangAction').click(function () {
                    $('#masalahAnggotaTable').show();  
                    $('#masalahKelompokTable').show();
