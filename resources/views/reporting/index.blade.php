                                        ...
                                        <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        <input type="text" class="form-control form-control-solid ps-13" id="cari-tanggal-laporan" placeholder="KEYWORD" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-3 mt-9">
                                                    <button id="laporanHarianAction" class="btn btn-flex btn-primary h-40px fs-7 fw-bold"><i class="fa fa-search"></i>Submit</button>
                                                </div>
                                            </div>
