											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="cariAnggotaTable" style="display: none">
												<thead>
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-100px">Cek Tabungan</th>
                    ...
                    if ($.fn.dataTable.isDataTable('#cariAnggotaTable')) {
                        ...
                        cariAnggotaTable = $('#cariAnggotaTable').DataTable({
                            ...
                            columns: [
                                ...
                                {data: 'cek_tabungan_view', name: 'cek_tabungan_view', orderable: false, searchable: false},
                                {data: 'cek_tabungan', name: 'cek_tabungan', orderable: false, searchable: false}
                            ]
                        });
                    }
                }
