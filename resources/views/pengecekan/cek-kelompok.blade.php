@include('layout.header')
								...
								<div id="kt_app_content" class="app-content">
									...
									<div class="card">
										<div class="card-body py-4">
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="cekKelompokTable" style="display: none">
												<thead>
        ...
        <script>
            $(document).ready(function () {
                var cekKelompokTable;        
                function initializeDataTable() {
                    if ($.fn.dataTable.isDataTable('#cekKelompokTable')) {
                        cekKelompokTable.ajax.reload();
                    } else {
                        // Otherwise, initialize the DataTable
                        cekKelompokTable = $('#cekKelompokTable').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: {
                ...
                $('#cariKelompokAction').click(function () {
                    $('#cekKelompokTable').show();  // Show the table when the search button is clicked
