									...
									<div id="kt_app_toolbar" class="app-toolbar d-flex flex-column py-6">
										<div class="app-toolbar-wrapper d-flex align-items-center flex-stack flex-wrap gap-2 py-4 w-100">
											...
											<div class="d-flex align-items-center gap-2 gap-lg-3">
												<a href="{{route('dosenPA');}}" class="btn btn-flex btn-danger h-40px fs-7 fw-bold"> <i class="fa fa-rotate"></i> Kembali</a>
											</div>
										</div>
									</div>
									<!--begin::Card-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-4 fv-row">
                                                        <label class="required form-label">Pilih Dosen PA</label>
                                                        <select id="detail-dosen-user" class="form-control mb-2">
                                                            <option value="">--Pilih Dosen PA---</option>
                                                            @foreach($dosen as $dosen)
                                                            <option <?php if($dosen->id_user == $user->dosen_pa){ echo "selected"; }?> value="{{$dosen->id_user}}">{{$dosen->nama}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
