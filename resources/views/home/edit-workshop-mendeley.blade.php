@include('layout.header')
									...
									<div id="kt_app_toolbar" class="app-toolbar d-flex flex-column py-6">
										<div class="app-toolbar-wrapper d-flex align-items-center flex-stack flex-wrap gap-2 py-4 w-100">
											...
											<div class="d-flex align-items-center gap-2 gap-lg-3">
												<a href="{{route('workshopMendeleyAdm');}}" class="btn btn-flex btn-danger h-40px fs-7 fw-bold"> <i class="fa fa-rotate"></i> Kembali</a>
											</div>
										</div>
									</div>
									<!--begin::Card-->
                                                    ...
                                                    <div class="row my-6 mx-6">
                                                        <div class="col-md-6 mb-6">
                                                            <div class="form-group">
                                                                <label class="form-label">Bukti Join Webex</label><br>
																<a href="{{ Storage::url($wta->workshop) }}" target="_blank">Lihat File: {{ basename($wta->workshop) }}</a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 mb-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="edit-workshop-workshop">
                                                                    ...
                                                                    <option <?php if($wta->v_workshop == "Y"){ echo "selected"; } ?> value="Y">Diverifikasi</option>
                                                                    <option <?php if($wta->v_workshop == "T"){ echo "selected"; } ?> value="T">Ditolak</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        ...
                                                        <div class="col-md-12 mt-9 mb-4 d-flex justify-content-end">
                                                            <button id="updateVerifikasiMendeleyAction" class="btn btn-flex btn-primary h-40px fs-7 fw-bold"><i class="fa fa-save"></i>SIMPAN</button>
                                                        </div>
                                                    </div>   
                                                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                $(document).ready(function() {
                    $('#updateVerifikasiMendeleyAction').on('click', function(e) {
                        e.preventDefault();
                        ...
                        $.ajax({
                            url: '{{ route("verifikasiWorkshopMendeleyAction") }}',
                            type: 'POST',
                            data: {
                                id: wtaId,
                                workshop: workshop,
