@include('layout.header')
								...
								<div id="kt_app_content" class="app-content">
									...
									<div class="card">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="tableProgressta">
												<thead>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var table = $('#tableProgressta').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: "{{ route('getProgressTa') }}",
                        data: function (d) {
