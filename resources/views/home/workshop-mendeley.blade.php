@include('layout.header')
                                                ...
                                                <form action="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-6 text-end">
                                                            ...
                                                            <button type="submit" id="button-uplad-mendeley" {{$disabled}} class="btn btn-secondary">Upload Berkas</button>
															<?php } else {?>
																<button type="submit" id="button-uplad-mendeley" {{$disabled}} class="btn btn-secondary">Upload Berkas</button>
															<?php } ?>
                                                        </div>
		...
		<script>
			$(document).ready(function() {
				$('#button-uplad-mendeley').click(function(e) {
					e.preventDefault();
					...
					$.ajax({
						url: "{{ route('uploadMendeleypAction') }}",
						method: 'POST',
						data: formData,
						contentType: false,
						processData: false,
