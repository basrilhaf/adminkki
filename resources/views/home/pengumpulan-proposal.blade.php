                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-6">
                                                            <div class="form-group">
                                                                <?php if($priode == 3){ ?>
                                                                    <label class="form-label">Pendaftaran Ujian Proposal <?php if(isset($alur)){ ?> <span class="badge badge-{{$button}}">{{$text}}</span> <?php }?></label><br>
																	<?php }else if($priode == 4){ ?>
																		<label class="form-label">Pengumpulan Revisi Proposal <?php if(isset($alur)){ ?> <span class="badge badge-{{$button}}">{{$text}}</span> <?php }?></label><br>
                                                                <?php } else {?>
                                                                    <label class="form-label">Pengumpulan Proporsal Tahap {{$priode}} <?php if(isset($alur)){ ?> <span class="badge badge-{{$button}}">{{$text}}</span> <?php }?></label><br>
                                                                <?php }?>
		...
		<script>
			$(document).ready(function() {
				$('#button-uplad-pengumpulan').click(function(e) {
					...
					$.ajax({
						url: "{{ route('uploadProposalpAction') }}",
						method: 'POST',
						data: formData,
						contentType: false,
						processData: false,
