                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        <select class="form-control form-control-solid ps-13" id="cari-berdasarkan-anggota">
                                                            ...
                                                            <option value="4">Nama Kelompok</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        <input type="text" class="form-control form-control-solid ps-13" id="search-nama-anggota" placeholder="nama kelompok" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        <input type="text" class="form-control form-control-solid ps-13" id="search-kelompok-anggota" placeholder="kelompok terakhir" />
                                                    </div>
                                                </div>
